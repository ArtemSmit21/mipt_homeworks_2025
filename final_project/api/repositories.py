...
async def search_repositories(
    limit: int = Query(..., ge=1, description="Количество репозиториев"),
    ...
    updated_after: Optional[date] = Query(default=None, description="Искать репозитории, обновленные после этой даты (YYYY-MM-DD)"),
