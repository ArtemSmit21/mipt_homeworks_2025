...
class RepositoryService:
    ...
    def _build_query(
        ...
        if updated_after is not None:
            query_parts.append(f"pushed:>{updated_after.isoformat()}")
    ...
    async def search_and_save(
        ...
        query = self._build_query(lang, stars_min, stars_max, forks_min, forks_max, updated_after)
